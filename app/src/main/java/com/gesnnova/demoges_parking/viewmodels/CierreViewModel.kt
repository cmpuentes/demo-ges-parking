...
import com.gesnnova.demoges_parking.model.CierreResponseDTO
...
//    }
        ...
        viewModelScope.launch {
            ...
            try {
                val request = CierreRegistroRequest(
                    ...
                    abonoEfectivo = _totalEfectivoAbono.value,
                    abonoTarjeta = _totalTarjetaAbono.value,
                    abonoTransferencia = _totalTransferenciaAbono.value
                )
    ...
    fun calcularReacaudoTotal(){
        _totalRecaudado.value = _totalEfectivo.value + _totalTarjeta.value + _totalTransferencia.value
    }
