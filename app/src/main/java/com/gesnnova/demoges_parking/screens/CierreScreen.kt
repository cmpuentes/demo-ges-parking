...
fun CierreScreen(navController: NavController, sessionViewModel: SessionViewModel, viewModel: CierreViewModel = viewModel()){
    ...
    val totalefectivoabono by viewModel.totalEfectivoAbono.collectAsState()
    val totaltarjetaabono by viewModel.totalTarjetaAbono.collectAsState()
    val totaltransferenciaabono by viewModel.totalTransferenciaAbono.collectAsState()
    ...
    val totalefectivoabonoformateado = totalefectivoabono.let {
        NumberFormat.getNumberInstance(Locale.US).format(it)
    }?: "N/A"
    val totaltarjetaabonoformateado = totaltarjetaabono.let {
        NumberFormat.getNumberInstance(Locale.US).format(it)
    }?: "N/A"
    val totaltransferenciaabonoformateado = totaltransferenciaabono.let {
        NumberFormat.getNumberInstance(Locale.US).format(it)
    }?: "N/A"
    ...
    LaunchedEffect(cierre) {
        cierre?.let { cierreData ->
            printViewModel.imprimirCierre(
                context = context,
                data = cierreData,
                efectivoAbono = viewModel.totalEfectivoAbono.value,
                tarjetaAbono = viewModel.totalTarjetaAbono.value,
                transferenciaAbono = viewModel.totalTransferenciaAbono.value
            )
        }
    }
                    ...
                    Text(
                        buildAnnotatedString {
                            ...
                            withStyle(
                                ...
                                append(totalefectivoabonoformateado)
                            }
                        },
                        fontSize = 15.sp,
                        color = Color.Black
                    ...
                    Text(
                        buildAnnotatedString {
                            ...
                            withStyle(
                                ...
                                append(totaltarjetaabonoformateado)
                            }
                        },
                        fontSize = 15.sp,
                        color = Color.Black
                    ...
                    Text(
                        buildAnnotatedString {
                            ...
                            withStyle(
                                ...
                                append(totaltransferenciaabonoformateado)
                            }
                        },
                        fontSize = 15.sp,
                        color = Color.Black
